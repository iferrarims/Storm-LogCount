...
public class MethodCountBolt extends BaseWindowedBolt {
	...
	private static final Logger LOG = LoggerFactory.getLogger(MethodCountBolt.class);
	...
	public void execute(TupleWindow inputWindow) {
        ...
        System.out.println("MethodCountBolt: Events in current window: " + tuplesInWindow.size() + " timestamp: " + System.currentTimeMillis());
